# Django settings for sysunevernote project.
import os,sys 
...
SECRET_KEY = '627ywsw+q33ay=1nb)0@kl$j$%a)@o+4skt!-!g*1g*wy#+c&amp;='
...
WSGI_APPLICATION = 'sysunevernote.wsgi.application'
...
if debug:
	TEMPLATE_DIRS = (
	 ...
	 # Always use forward slashes, even on Windows.
	 # Don't forget to use absolute paths, not relative paths.
		"/home/superhan/work/nevernote/sysunevernote/1"
	)
else:
	TEMPLATE_DIRS = (
		"/data1/www/htdocs/967/sysunevernote/1"		
	)
